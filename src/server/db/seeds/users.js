  ...
  return knex('users').del()
    .then(function () {
      return Promise.all([
        ...
        knex('users').insert({first_name: 'Turd', last_name: 'Ferguson', email: 'turd@turd.com', password: 'turd1', permissions: 'guest'}),
        knex('users').insert({first_name: 'Harry', last_name: 'Potter', email: 'harry@harry.com', password: 'harry1', permissions: 'visitor'}),
      ]);
    });
};
